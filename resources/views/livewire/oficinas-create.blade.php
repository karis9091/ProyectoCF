<div>
    ...
    <div class="card card-primary">
        ...
        <div class="col-sm-10">
        <input wire:model='data.direccion'type="text" class="form-control" id="inputDireccion" placeholder="Direccion">
        </div>
        </div>
        <div class="form-group row">
        <label for="inputProvincia" class="col-sm-4 col-form-label">Provincia</label>
        <div class="col-sm-10">
        <input wire:model='data.provincia' type="text" class="form-control" id="inputProvincia" placeholder="Provincia">
        </div>

        <div class="form-group row">
            <label for="inputLocalidad" class="col-sm-4 col-form-label">Localidad</label>
            <div class="col-sm-10">
            <input wire:model='data.localidad' type="text" class="form-control" id="inputLocalidad" placeholder="Localidad">
            <br>
